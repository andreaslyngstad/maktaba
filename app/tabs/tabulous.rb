...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #----------------------------------------------------------------------------------------------------#
      [    :interface_tab    ,    'Dashboard'     ,    admin_interface_path    ,    true        ,    true        ],
      [    :comments_tab     ,    'Comments'      ,    admin_comments_path     ,    true        ,    true        ],
      [    :posts_tab        ,    'Posts'         ,    admin_posts_path        ,    true        ,    true        ],
      [    :works_tab        ,    'Works'         ,    admin_works_path        ,    true        ,    true        ],
      [    :users_tab        ,    'Users'         ,    admin_users_path        ,    true        ,    true        ],
      [    :authors_tab      ,    'Authors'       ,    admin_authors_path      ,    true        ,    true        ],
      [    :countries_tab    ,    'Countries'     ,    admin_countries_path    ,    true        ,    true        ],
      [    :languages_tab    ,    'Languages'     ,    admin_languages_path    ,    true        ,    true        ],
      [    :language_in_countries_tab    ,    'Lang. in countries'     ,    admin_language_in_countries_path    ,    true        ,    true        ],
      [    :settings_tab    ,    'Settings'     ,    admin_settings_path    ,    true        ,    true        ],
      #----------------------------------------------------------------------------------------------------#
      #    TAB NAME          |    DISPLAY TEXT    |    PATH              |    VISIBLE?    |    ENABLED?    #
      #----------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #--------------------------------------------------------------#
      [    :interface      ,    :all_actions    ,    :interface_tab  ],
      [    :comments     ,    :all_actions    ,    :comments_tab     ],
      [    :posts        ,    :all_actions    ,    :posts_tab        ],
      [    :works       ,    :all_actions    ,    :works_tab         ],
      [    :users        ,    :all_actions    ,    :users_tab        ],
      [    :authors      ,    :all_actions    ,    :authors_tab      ],
      [    :countries    ,    :all_actions    ,    :countries_tab    ],
      [    :languages    ,    :all_actions    ,    :languages_tab    ],
      [    :language_in_countries    ,    :all_actions    ,    :language_in_countries_tab    ],
